...
public class QuestionAndAnswer extends InteractiveMission {
	...
	str = str.replaceAll(TOKEN_CORRECT,
			     correctAnswers + "");
	str = str.replaceAll(TOKEN_INCORRECT,
			     incorrectAnswers + "");
	str = str.replaceAll(TOKEN_REQUIRED,
			     correctAnswersNeeded + "");
	str = str.replaceAll(TOKEN_QUESTIONS,
			     questions.size() + "");
	return (str);
    }
	...
	CharSequence correctAnswersNeededAsText = getMissionAttribute("correctAnswersNeeded",

...
public class NFCMission extends InteractiveMission implements OnClickListener {
		...
		if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(intent.getAction())) {
			...
			for (int i = 0; i < len; i++) {
				...
				for (NdefRecord record : records) {
					...
					Log.d(TAG, "Ndef TNF = " + record.getTnf());
			...
			Log.d(TAG, "NFC Tag Id = " + new String(idArr));
		}
	}
	...
	public void onClick(View v) {
		...
		case R.id.resetNfcInfobutton:
			...
			try {
				...
				{
					Toast.makeText(getApplicationContext(), "Information Replaced.", Toast.LENGTH_SHORT).show();
				}else{
					Toast.makeText(getApplicationContext(), "ERROR! Touch the NFC Tag.", Toast.LENGTH_SHORT).show();
				}

...
public class GQ_OSM_MapView extends MapView {
	...
	// final double maxZoomLatitudeSpan = getZoomLevel(false) ==
	// getMaxZoomLevel() ? currentBox
	...
	//
	// }
	// final double requiredLatitudeZoom = maxZoomLatitudeSpan < 0.001 ?
	// getMaxZoomLevel()
	// : getMaxZoomLevel()
	...
	// final double maxZoomLongitudeSpan = getZoomLevel(false) ==
	// getMaxZoomLevel() ? currentBox
	// .getLongitudeSpanE6() : currentBox.getLongitudeSpanE6()
	// / Math.pow(2, getMaxZoomLevel() - getZoomLevel(false));
	//
	// final double requiredLongitudeZoom = maxZoomLongitudeSpan < 0.001 ?
	// getMaxZoomLevel()
	// : getMaxZoomLevel()
	...
	// int newZoomLevel = (int) (requiredLatitudeZoom < requiredLongitudeZoom ?
